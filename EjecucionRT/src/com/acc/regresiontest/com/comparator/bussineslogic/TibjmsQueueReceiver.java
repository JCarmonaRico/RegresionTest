 ...
 * 
 * $Id: tibjmsQueueReceiver.java 21731 2006-05-01 21:41:34Z rselph $
 * 
 */
...
public class TibjmsQueueReceiver
{
    ...
    String      queueName       = "regresionTest.event.queue";
    
    public TibjmsQueueReceiver(String[] args) throws IOException {
       ...
       /* print parameters */
        ...
        try
        {
            ...
            while(true)
            {
                ...
                if (message == null){
                System.out.println("entro en el if del mensaje vacio");
                	break;
                }
                    
                else{
                	System.out.println("entro en el else");
                	FileWriter fw = new FileWriter("XMLTIBCO.xml", true);
