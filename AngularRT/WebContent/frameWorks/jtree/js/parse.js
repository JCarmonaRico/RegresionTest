...
function parseValue(val, parent, level)
{
   ...
   if(typeof(val) == "object")
   {
      ...
      if(val instanceof Array)
      {
         ...
         if(val.length > 0)
         {
            //out += "<table class='arraytable' border=\"1\" cellpadding=\"1px\" bgcolor=\"#BEF781\" width=\"100%\">\n<tr><th>Index</th><th>Value</th></tr>\n";
            
            for(prop in val)
            {
               if(typeof(val[prop]) == "function") continue;
               //out += "<tr><td>" + prop + "</td><td>" + parseValue(val[prop], parent, level + 1) + "</td></tr>\n";
               out += parseValue(val[prop], parent, level + 1) + "<br />";
            }
      ...
      else
      {
         ...
         if(i > 0)
         {
            out += "<table class='objecttable' border=\"1\" cellpadding=\"1px\" width=\"100%\">\n<tr bgcolor=\"#BEF781\"><th>Name</th><th>Value</th></tr>\n";
            for(prop in val)
            {
               if(typeof(val[prop]) == "function") continue;
               out += "<tr bgcolor=\"#F2F5A9\"><td>" + prop + "</td><td>" + parseValue(val[prop], parent, level + 1) + "</td></tr>\n";
            }
